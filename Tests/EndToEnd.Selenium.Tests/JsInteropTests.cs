namespace TransactionProject.EndToEnd.Tests
{
  using TransactionProject.EndToEnd.Tests.Infrastructure;
  ...
  public class JsInteropTests : BaseTest
  {
      ...
      : base(aWebDriver, aServerFixture)
    {
      ...
      clientApplication.ShouldBe("TransactionProject.Client.0.0.1");
    }
